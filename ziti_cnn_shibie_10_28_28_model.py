...
# 构造第2个卷积和池化层
W_conv2 = weight_variable([5, 5, 2, 8],name='W_conv2')
b_conv2 = bias_variable([8],name='b_conv2')
h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2) + b_conv2)
h_pool2 = max_pool_2x2(h_conv2)
#全连接层
W_fc1 = weight_variable([7 * 7 * 8, 1024],name='W_fc1')
...
with tf.Session() as sess:
    ...
    for k in range(epoch):
        ...
        for i in range(batch_num):
            ...
            if (i % record_step == 0):
                ...
                saver.save(sess, "model_cnn10_28_28/model_cnn10_28_28", global_step=k*batch_num+i)
    ...
    saver.save(sess, "model_cnn10_28_28/model_cnn10_28_28", global_step=k * batch_num + i+1)
