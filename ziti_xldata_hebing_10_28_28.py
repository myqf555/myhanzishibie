...
XL=np.load('ziti_xldata_10_28_28.npz')
...
xl_image=xl_image_temp
xl_label=xl_label_temp
# data_xl = np.hstack([xl_image_temp, xl_label_temp])

np.savez('ziti_xldata_hebing_10_28_28.npz',xl_image=xl_image,xl_label=xl_label)
