...
CS=np.load('ziti_csdata_10_28_28.npz')
...
cs_image=cs_image_temp
cs_label=cs_label_temp
# data_cs = np.hstack([cs_image_temp, cs_label_temp])

np.savez('ziti_csdata_hebing_10_28_28.npz',cs_image=cs_image,cs_label=cs_label)
